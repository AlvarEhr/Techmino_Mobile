...
scene.widgetList={
    ...
    WIDGET.newSwitch{name='gestureMode',x=450, y=150, lim=300,                  disp=SETval('gestureMode'),code=SETrev('gestureMode'),hideF=function() return not MOBILE end},
    WIDGET.newSwitch{name='maximizeMode',x=450,y=610, lim=300,                  disp=SETval('maximizeMode'),code=SETrev('maximizeMode'),hideF=function() return not SETTING.portrait end},
