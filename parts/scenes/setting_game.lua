...
scene.widgetList={
    ...
    WIDGET.newSwitch{name='maximizeMode',x=450,y=150, lim=300,                  disp=SETval('maximizeMode'),code=SETrev('maximizeMode'),hideF=function() return not SETTING.portrait end},
